...
import AddStructureForm from "../../Forms/ElectionAreaForms/AddStructureForm";



const ListStrucurePageComponent: React.FC = () => {
	...
	const [link, setLink] = useState(`${BACKENDAPI}/v1.0/house-structure`);
	...
	const deleteData = (id: number) => {
		if (window.confirm("Are you sure  want to delete ?")) {
			apiClient()
				.delete(`${BACKENDAPI}/v1.0/house-structure/${id}`)
				.then((response: any) => {
...
export default ListStrucurePageComponent;
