...
const ListPostOfficePageComponent: React.FC = () => {
	...
	const [link, setLink] = useState(`${BACKENDAPI}/v1.0/post-office`);
	...
	const deleteData = (id: number) => {
		if (window.confirm("Are you sure  want to delete ?")) {
			apiClient()
				.delete(`${BACKENDAPI}/v1.0/post-office/${id}`)
				.then((response: any) => {
...
export default ListPostOfficePageComponent;
