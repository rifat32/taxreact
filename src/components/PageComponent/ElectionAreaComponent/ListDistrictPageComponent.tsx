...
import AddDistrictForm from "../../Forms/ElectionAreaForms/AddDistrictForm";
import { districtsLang } from "../../../language/bn/district";



const ListDistrictPageComponent: React.FC = () => {
	...
	const [link, setLink] = useState(`${BACKENDAPI}/v1.0/districts`);
	...
	const deleteData = (id: number) => {
		if (window.confirm("Are you sure  want to delete ?")) {
			apiClient()
				.delete(`${BACKENDAPI}/v1.0/districts/${id}`)
				.then((response: any) => {
			...
			<table className="table">
				<thead>
					<tr>
						...
						<th scope="col">{districtsLang.id}</th>
						<th scope="col">{districtsLang.name}</th>
...
export default ListDistrictPageComponent;
