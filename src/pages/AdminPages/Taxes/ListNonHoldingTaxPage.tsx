...
const ListNonHoldingTaxPage: React.FC = () => {
	return (
		<AdminPageComponent>
							...
							<div className="card">
								<div className="card-body">
									<div className="d-flex justify-content-between align-items-end">
										<h5 className="card-title">নন হোল্ডিং ট্যাক্স সমূহ </h5>
										<Link
											to={ROUTE_LIST.createNonHoldingTax}
											className="btn btn-primary">
											Add Data
										</Link>
									</div>
									<ListNonHoldingTaxPageComponent />
								</div>
							</div>
						</div>
					</div>
...
export default ListNonHoldingTaxPage;
