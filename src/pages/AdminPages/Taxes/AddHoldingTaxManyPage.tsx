...
import AddHoldingTaxManyForm from "../../../components/Forms/TaxForms/AddHoldingTaxManyForm";

import AdminPageComponent from "../../../components/PageComponent/AdminPageComponent";



const AddHoldingTaxManyPage: React.FC = () => {
	return (
		<AdminPageComponent>
...
export default AddHoldingTaxManyPage;
