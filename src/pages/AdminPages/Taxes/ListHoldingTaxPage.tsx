...
const ListHoldingTaxPage: React.FC = () => {
	return (
		<AdminPageComponent>
							...
							<div className="card">
								<div className="card-body">
									<div className="d-flex justify-content-between align-items-end">
										<h5 className="card-title"> হোল্ডিং ট্যাক্স সমূহ</h5>
										<Link
											to={ROUTE_LIST.createHoldingTax}
											className="btn btn-primary">
											Add Data
										</Link>
									</div>
									<ListHoldingTaxPageComponent />
								</div>
							</div>
						</div>
					</div>
...
export default ListHoldingTaxPage;
